package junction.global.infra.exception;


import junction.global.infra.exception.error.ErrorCode;
import junction.global.infra.exception.error.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(JunctionException.class)
    public ResponseEntity<ErrorResponse> handleFlowException(JunctionException e) {
    ...
    public ResponseEntity<ErrorResponse> handleJsonParseError(HttpMessageNotReadableException e) {
        ...
        if (rootCause instanceof JunctionException babException) {
            return ResponseEntity
